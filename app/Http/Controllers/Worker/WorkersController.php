...
class WorkersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('worker.workers.index', compact('workers'));
    }
    ...
    {
        return view('worker.workers.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('worker.workers.show', compact('worker'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('worker.workers.edit', compact('worker'));
    }
