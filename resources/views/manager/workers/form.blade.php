...
</div><div class="form-group {{ $errors->has('workrole_id') ? 'has-error' : ''}}">
    {!! Form::label('workrole_id', 'Workrole Id', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::number('workrole_id', null, ['class' => 'form-control']) !!}
...
</div><div class="form-group {{ $errors->has(''workgroup_id') ? 'has-error' : ''}}">
    {!! Form::label(''workgroup_id', ''workgroup Id', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::number(''workgroup_id', null, ['class' => 'form-control']) !!}
        {!! $errors->first(''workgroup_id', '<p class="help-block">:message</p>') !!}
    </div>
