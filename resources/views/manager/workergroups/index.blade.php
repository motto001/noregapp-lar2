        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Workergroups</div>
                    <div class="panel-body">
                        <a href="{{ url('/manager/workergroups/create') }}" class="btn btn-success btn-sm" title="Add New Workergroup">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/manager/workergroups', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
