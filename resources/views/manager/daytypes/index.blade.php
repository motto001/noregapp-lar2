        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Daytypes</div>
                    <div class="panel-body">
                        <a href="{{ url('/manager/daytypes/create') }}" class="btn btn-success btn-sm" title="Add New Daytype">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/manager/daytypes', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                                ...
                                @foreach($daytypes as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {!! Form::open([
                                                'method'=>'DELETE',
                                                'url' => ['/manager/daytypes', $item->id],
                                                'style' => 'display:inline'
                                            ]) !!}
                                                {!! Form::button('<i class="fa fa-trash-o" aria-hidden="true"></i> Delete', array(
                                                        'type' => 'submit',
                                                        'class' => 'btn btn-danger btn-xs',
                                                        'title' => 'Delete Daytype',
                            ...
                            <div class="pagination-wrapper"> {!! $daytypes->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
