...
</div><div class="form-group {{ $errors->has('user.email') ? 'has-error' : ''}}">
    {!! Form::label('user.email', 'User.email', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('user.email', null, ['class' => 'form-control']) !!}
        {!! $errors->first('user.email', '<p class="help-block">:message</p>') !!}
    </div>
</div><div class="form-group {{ $errors->has('user.password') ? 'has-error' : ''}}">
    {!! Form::label('user.password', 'User.password', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
